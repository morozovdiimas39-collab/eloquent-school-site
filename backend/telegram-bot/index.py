    ...
    try:
        ...
        # Команда /modes - выбор режима обучения
            ...
            send_telegram_message(
                ...
                '💬 <b>Диалог</b> - свободное общение с Аней. Практикуй разговорную речь в естественных диалогах\n\n'
                '✍️ <b>Предложения</b> - составляй предложения с изученными словами. Развивай навык построения фраз\n\n'
                '📝 <b>Контекст</b> - вставляй пропущенные слова в предложения. Учись понимать слова в контексте\n\n'
                '🎯 <b>Ассоциации</b> - угадывай слова по трём подсказкам. Тренируй словарный запас через ассоциативное мышление\n\n'
                '🇷🇺→🇬🇧 <b>Перевод</b> - переводи слова с русского на английский. Закрепляй знание лексики',
                keyboard
            )
        else:
