    ...
    try:
        ...
        if text == '/start':
            ...
            if not existing_user:
                ...
                # Новое приветствие для нового пользователя с готовыми кнопками
                goal_keyboard = {
                    'inline_keyboard': [
                        [{'text': '✈️ Путешествия', 'callback_data': 'goal_travel'}],
                        [{'text': '💼 Карьера и работа', 'callback_data': 'goal_career'}],
                        [{'text': '💬 Общение и жизнь', 'callback_data': 'goal_communication'}],
                        [{'text': '🎓 Учеба и экзамены', 'callback_data': 'goal_study'}],
                        [{'text': '✍️ Своя цель (напиши сам)', 'callback_data': 'goal_custom'}]
                    ]
                }
                ...
                send_telegram_message(
                    ...
                    'Расскажи мне - к какому результату ты хочешь прийти?\n\n'
                ...
                # Возвращающийся пользователь - тоже показываем новый флоу с кнопками
                goal_keyboard = {
                    'inline_keyboard': [
                        [{'text': '✈️ Путешествия', 'callback_data': 'goal_travel'}],
                        [{'text': '💼 Карьера и работа', 'callback_data': 'goal_career'}],
