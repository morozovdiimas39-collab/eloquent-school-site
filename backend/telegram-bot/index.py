...
- Be encouraging but don't skip corrections!"""
    ...
    # Подготавливаем запрос к Gemini REST API - используем gemini-1.5-flash-002 (15 RPM, stable)
    gemini_url = f'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-002:generateContent?key={api_key}'
