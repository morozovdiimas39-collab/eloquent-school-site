...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="container mx-auto px-4 py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="max-w-6xl mx-auto">
            ...
            <div key={idx} className="relative">
              <Card className="border-2 hover:shadow-xl transition-all h-full bg-white">
                <CardContent className="p-6">
                  <div className="relative">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center mb-4 shadow-lg">
                      <Icon name={step.icon as any} size={28} className="text-white" />
                    </div>
                    <div className="absolute -top-3 -right-3 w-10 h-10 rounded-full bg-blue-600 text-white font-bold flex items-center justify-center text-lg shadow-lg">
                      {idx + 1}
                    </div>
                  </div>
              ...
              {idx < steps.length - 1 && (
                <div className="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
                  <Icon name="ArrowRight" size={24} className="text-blue-400" />
                </div>
              )}
            </div>
          ))}
        ...
        <div className="mt-12 text-center">
          <Card className="inline-block border-2 border-blue-200 bg-gradient-to-br from-white to-blue-50">
