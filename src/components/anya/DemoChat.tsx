                    ...
                    <Card className="overflow-hidden border-0">
                      ...
                      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-4 py-3 flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <div className="font-semibold text-white text-sm">Anya AI</div>
                      ...
                      {showTelegramButton ? (
                        <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 border-t border-purple-100">
                          <Button
                            onClick={() => window.open(TELEGRAM_BOT_LINK, '_blank')}
                        ...
                        <div className="p-4 bg-white border-t border-gray-200 space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {quickPhrases.slice(0, 2).map((phrase, index) => (
                              <button
                                key={index}
                                onClick={() => handleQuickPhrase(phrase)}
                                className="px-3 py-1.5 bg-gray-50 hover:bg-purple-50 text-gray-700 hover:text-purple-700 rounded-full text-xs font-medium border border-gray-200 hover:border-purple-300 transition-all"
                              >
                                {phrase}
                              </button>
                            ))}
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              disabled={isTyping}
                              className="flex-1 px-4 py-2.5 rounded-full border border-gray-300 focus:border-purple-400 focus:ring-2 focus:ring-purple-100 outline-none text-sm disabled:opacity-50"
                            />
                            <Button
                              onClick={handleSend}
                              disabled={!input.trim() || isTyping}
                              size="sm"
                              className="px-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:opacity-50"
                            >
